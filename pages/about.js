    ...
    return (
        <section className="font-custom">
            ...
            <section className="flex flex-col md:flex-row content-center">
                ...
                <h3 className="text-xl sm:text-2xl m-1 font-bold">Mission Briefing: Who I am</h3>
                <p className="m-3 w-4/5 text-left leading-relaxed">I am a recent graduate in Information Architecture, with a deep passion for the development of innovative software, particularly in the vast space of the web.
                </p>
                <p className="m-3 w-4/5 text-left leading-relaxed">Throughout my academic journey, I’ve equipped myself with a robust foundation in user experience principles, the art of information organization, and the latest advancements in web technologies. This knowledge has not only enabled me to understand how users interact with digital environments but has also fueled my mission to make these experiences as seamless and engaging as possible.</p>
                <p className="m-3 w-4/5 text-left leading-relaxed"> Each day, I continue to explore new frontiers in my craft—whether it’s through self-learning, engaging with new projects, or refining my skills. This constant drive to stay on the cutting edge ensures that my abilities remain sharp and ready to tackle whatever challenges lie ahead in the digital cosmos.</p>
                </section>
                <section className="flex flex-col items-center">
                <h3 className="text-2xl m-1 font-bold">Mission Objective: Future Career Vision</h3>
                <p className="m-3 w-4/5 text-left leading-relaxed">I seek to join a dynamic, forward-thinking team where I can contribute my skills and boundless enthusiasm to the creation of exceptional user experiences and innovative web solutions. The opportunity to collaborate with like-minded individuals to push the boundaries of what’s possible in digital space is one I look forward to.
                </p>
                <p className="m-3 w-4/5 text-left leading-relaxed pb-10"> My goal is to create user experiences, that are functional and pleasant for the user. I am also working towards becoming a fullstack-developer, which will enable me to construct both the frontend and backend of projects — ensuring that every mission I embark on is complete, scalable, and impactful.</p>
                </section>
            </section>
            <Link href="/projects">
            <Button
